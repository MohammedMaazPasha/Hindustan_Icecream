               ...
               <div class="col-md-8">
                  <div class="location_text">
                     <ul>
                        ...
                        <li>
                           <a href="#">
                           <span class="padding_left_10"><i class="fa fa-phone" aria-hidden="true"></i></span>Call : +91 6361469316
                           </a>
                        </li>
                        <li>
                           <a href="#">
                           <span class="padding_left_10"><i class="fa fa-envelope" aria-hidden="true"></i></span>Email : hindustanicecream2331@gmail.com
                           </a>
                        </li>
                     </ul>
                  </div>
